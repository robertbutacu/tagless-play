...
import generic.independent.filter.{GenericAction, GenericActionFilter, GenericActionRefiner}
import play.api.libs.json.Json
import play.api.mvc._
import generic.independent.filter.ActionBuilderExtensionMethod.GenericActionBuilder
...
private[experiments] object Experiments extends App {
  ...
  class RequestFiltered[F[_]]()(implicit val toFuture: F ~> Future,
                                ...
                                val M: Monad[F]) extends GenericActionFilter[F, Request] {
  ...
  class ExtraRequest[F[+ _]]()(implicit val toFuture: F ~> Future,
    ...
    override protected def ec: ExecutionContext = ec
  ...
  class ComposedActions[F[+ _]](
    ...
    def filtered: GenericAction[F, Request, RequestWithProviderId] = Action.toGenericAction andThen requestFiltered andThen extraRequest
  }
